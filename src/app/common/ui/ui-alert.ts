import UiAlert from '@/app/components/ui/ui-dialog/UiAlert.vue';
import type { IAlertOption, IAlertStatusList } from './types';
...
export class Alert {
	...
	public innerClose(inst: any) {
		console.log('ui alert close!!', inst);
		if (!inst) {
			return;
		}
